...
class _HomeState extends State<Home> {
  ...
  void Bmirechner(double height, double weight) {
  ...
  void Kaloriesrechner(double height, double weight, double alter) {
    ...
    if (geschlechtvalue) {
      grundkalorie =
      (655.0955 + (9.5634 * weight) + (1.8496 * height) - (4.6756 * alter));
      geschlecht ='männlich';

    } else {
      grundkalorie =
      (66.4730 + (13.7516 * weight) + (5.0033 * height) - (6.7550 * alter));
      geschlecht = 'weiblich';
    }
    switch (int.parse(aktivitaet)) {
      ...
      case 3:
        ...
        Aktivitaet ='vorwiegend sitzende Tätigkeit, kaum körperliche Aktivität';
        break;
      case 4:
        finalkalorie = (grundkalorie * 1.65);
        Aktivitaet ='überwiegend sitzende Tätigkeit, dazwischen auch stehend/ gehend';
        break;
      case 5:
  ...
  void Wassermenge(double weight, double alter) {
    double wasser = ((weight * alter) / 28.3) * (0.03);
