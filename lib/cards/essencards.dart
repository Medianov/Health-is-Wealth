...
class essenabnahme extends StatefulWidget {
  const essenabnahme({Key? key}) : super(key: key);

  @override
  _essenabnahmeState createState() => _essenabnahmeState();
}

class _essenabnahmeState extends State<essenabnahme> {
  @override
...
class essenbeibehalten extends StatefulWidget {
  const essenbeibehalten({Key? key}) : super(key: key);

  @override
  _essenbeibehaltenState createState() => _essenbeibehaltenState();
}

class _essenbeibehaltenState extends State<essenbeibehalten> {
  @override
  Widget build(BuildContext context) {
    return Row(
      children: [
...
class essenzunahme extends StatefulWidget {
  const essenzunahme({Key? key}) : super(key: key);

  @override
  _essenzunahmeState createState() => _essenzunahmeState();
}

class _essenzunahmeState extends State<essenzunahme> {
  @override
  Widget build(BuildContext context) {
    return Row(
      children: [
